...
public class ContactUseCase(IUnitOfWork unitOfWork, IValidator<Contacts.Domain.Entities.Contact> validator) : IContactUseCase
{
    public async Task<PagedResult<ContactDto>> GetAllAsync(ContactQueryParameters parameters, CancellationToken cancellationToken)
    {
